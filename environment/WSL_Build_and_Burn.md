...
- 打开Vscode，在“远程资源管理器”打开“fbb_ws63”子系统
  ...
  ![image-20250311110526878](./pic/image-20250311110526878.png)

- 在“终端”新建一个终端

  ![image-20250311110825993](./pic/image-20250311110825993.png)


- 在新终端中输入`git clone https://gitee.com/HiSpark/fbb_ws63.git`指令下载代码，等待下载完成。

![image-20240807151920249](./pic/image-20240807151920249.png)

## 星闪代码导入到VSCode

- 下载完成后,在"资源管理器"中选择打开文件夹

  ![image-20250311111016027](./pic/image-20250311111016027.png)

- 在弹出框中选择"/root/fbb_ws63/src"目录，点击确定

  ![image-20250311111103585](./pic/image-20250311111103585.png)
...
- Menuconfig 配置，运行“python3 build.py -c ws63-liteos-app menuconfig”脚本会启动 Menuconfig 程 序，用户可通过Menuconfig 对编译和系统功能进行配置
  ...
  ![image-20250311114126273](./pic/image-20250311114126273.png)
...
- 这里以Enable Sample 》Enable the Sample of peripheral》Support BLINKY SAMPLE为例
  ...
  ![image-20250311114606721](./pic/image-20250311114606721.png)
  
- 按“Enter”依次选中，然后在按“ESC”退出，在弹出的对话框按“y”选择yes

  ![image-20250311115322015](./pic/image-20250311115322015.png)
...
- 等待编译完成，编译成功如下
  ...
  ![image-20250311115606569](./pic/image-20250311115606569.png)


## 镜像烧录


- 硬件搭建：使用Typec数据线将板端与PC端连接
...
- 安装驱动“CH341SER驱动”（[CH341SER驱动下载地址](https://www.wch.cn/downloads/CH341SER_EXE.html)，**如果该链接失效或者无法下载，用户自行百度下载即可**），安装CH341SER驱动，安装前单板需要与PC端相连，点击安装即可，显示**驱动安装成功代表成功**，如果出现**驱动预安装成功代表安装失败**
    ...
    ![image-20240801173439645](./pic/image-20240801173439645.png)

    ![image-20240801173618611](./pic/image-20240801173618611.png)
...
- 烧录完成结果如下：
  ...
  ![image-20250311144503520](./pic/image-20250311144503520.png)
